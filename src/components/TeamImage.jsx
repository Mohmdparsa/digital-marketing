...
const TeamImage = () => {
  return (
    <div className="flex flex-col lg:flex-row justify-center items-center mt-[10rem] lg:mt-2 overflow-x-hidden">
      <div>
        <img
          src={teamimagedesk}
          alt="teamimagedesk"
      ...
      <div className="flex flex-col mr-[10rem] lg:-mr-[32rem] hidden md:block mb-[10rem] lg:mb-0">
        <div>
